...
class _PurchaseDetailScreenState extends State<PurchaseDetailScreen> {
  ...
  TextStyle titleTextStyle =
      TextStyle(fontFamily: 'GillroyMedium', fontSize: 16);
  TextStyle valueTextStyle = TextStyle(
      fontFamily: 'GillroyMedium', fontSize: 16, fontWeight: FontWeight.w700);
  @override
        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: kColorWhite, borderRadius: BorderRadius.circular(15)),
